...
| [storybook-react-lynx-web-rsbuild](https://github.com/rstackjs/storybook-rsbuild/tree/main/packages/framework-react-lynx-web) | ReactLynx (web) integration rendered through `<lynx-view>` |
...
See [integrating with ReactLynx on the web](/guide/framework/react-lynx-web).
