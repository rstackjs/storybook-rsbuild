...
See the [React component library example](https://github.com/rstackjs/storybook-rsbuild/tree/main/sandboxes/rslib-react-component) for a full reference implementation.
